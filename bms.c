...
void display(char username1[])
{
	...
	// Menu taki insaan alag alag chiz ker sake
	printf(" HOME ");
	gotoxy(0, 7);
	printf("******");
	gotoxy(0, 9);
...
void transfermoney(void)
{
	...
	// Function home screen jane ke liye
	display(usernamet);
}

// Function to check insaan ka acc balance
void checkbalance(char username2[])
{
	...
	// Reading username to get the perfect edge detail insaan ki
	...
	// Closing file dekhne ke baad
	fclose(fm);
	display(username2);
}

// Logout function to bring insaan ko login screen lane ke liye
void logout(void)
{
	int i, j;
	system("cls");
